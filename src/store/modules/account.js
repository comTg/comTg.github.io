...
const state = {
  ...
  auth: {
    ...
    clientID: 'e1fe4a06a0fab52d383d',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: '7697e41efa7e89fceff4ae793a4c98dd2b511cc5'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  gitHubUser: null,  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: 'comTg',  // 修改成你自己的 GitHub 账号
  copyright: '2018 - 2022',  // 修改成你自己的
  recordNumber: null,  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'comTg/comTg.github.io',  // 记录 Issue 的仓库的全名「用户名/仓库名」
